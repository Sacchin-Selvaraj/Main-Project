...
import { User, Calendar, Mail, Home, Users, Utensils, Edit, LogOut, AlertTriangle, MessageSquare, CreditCard, RefreshCw } from 'lucide-react';
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button
                ...
                className="group flex items-center gap-2 px-6 py-3.5 
                  ...
                  hover:from-blue-600/20 hover:to-blue-500/20
                  text-blue-400 rounded-xl transition-all duration-300
