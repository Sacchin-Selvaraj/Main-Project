  ...
  const handleConfirmVacate = async () => {
    ...
    try {
      ...
      setRooms(prevRooms => 
        prevRooms.map(room => ({
          ...room,
          roommateList: room.roommateList?.filter(
      ...
      if (selectedRoom) {
        setSelectedRoom(prevRoom => {
          ...
          return {
            ...prevRoom,
            roommateList: prevRoom.roommateList?.filter(
              r => r.roommateId !== selectedRoommate.roommateId
            ) || [],
                      ...
                      <div
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            { label: 'AC', value: room.acAvailable ? 'Available' : 'Not Available' }
                          ].map(({ label, value }) => (
                          ...
                          <button
                            onClick={(e) => {
                              ...
                              setEditRoomData({
                                ...
                                isAcAvailable: room.acAvailable,
                                price: room.price
                              });
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'AC', value: selectedRoom.acAvailable ? 'Available' : 'Not Available' }
                ].map(({ label, value }) => (
                  <div key={label} className="flex items-center gap-3 text-purple-200/80">
                    <span className="w-2 h-2 rounded-full bg-purple-400/60"></span>
                    <span className="font-medium">{label}:</span>
              ...
              <div className="space-y-4">
                ...
                {selectedRoom.roommateList && selectedRoom.roommateList.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {selectedRoom.roommateList.map((roommate) => (
